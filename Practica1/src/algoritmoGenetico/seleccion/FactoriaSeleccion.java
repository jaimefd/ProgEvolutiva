...
public class FactoriaSeleccion {
	...
	static ArrayList<Individuo<Boolean>> getAlgoritmoSeleccion (String algoritmo, ArrayList<Individuo<Boolean>> poblacion,
			ArrayList<Double> puntAcu, int tamPobl, int participantes) {
		switch (algoritmo) {
